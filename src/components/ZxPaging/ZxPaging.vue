  ...
  <view>
    ...
    >
      ...
      <template #refresher="{ refresherStatus }">
        <zx-custom-refresher :status="refresherStatus" />
      </template>
      <!-- 自定义没有更多数据view -->
      <template #loadingMoreNoMore>
        <zx-custom-nomore></zx-custom-nomore>
      </template>
...
<script>
import ZxCustomRefresher from './components/ZxCustomRefresher.vue';
import ZxCustomNomore from './components/ZxCustomNomore.vue';
export default {
  name: 'ZxPaging',
  components: {
    ZxCustomRefresher,
